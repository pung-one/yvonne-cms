...
export interface ApiAboutPageAboutPage extends Schema.SingleType {
  ...
  attributes: {
    ...
    studioImage: Attribute.Media<'images'> & Attribute.Required;
    customers: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProjektProjekt extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Kunde: Attribute.String & Attribute.Required;
    HairMakeUp: Attribute.String & Attribute.Required;
    Assistent: Attribute.String & Attribute.Required;
    Bilder: Attribute.Media<'images', true> & Attribute.Required;
    positionOnLandingPage: Attribute.Integer &
      Attribute.Unique &
      Attribute.SetMinMax<
        {
          min: 0;
